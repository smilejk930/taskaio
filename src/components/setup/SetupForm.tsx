...
import { Database, User, ShieldCheck, Loader2, ArrowRight, CheckCircle2 } from 'lucide-react'
    ...
    return (
      <Card className="max-w-md w-full border-none shadow-2xl bg-white/80 backdrop-blur-xl animate-in fade-in zoom-in duration-500">
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-2xl font-bold text-slate-900">설치 완료!</CardTitle>
          <CardDescription>
  ...
  return (
    <Card className="max-w-lg w-full border-none shadow-2xl bg-white/90 backdrop-blur-xl transition-all duration-300">
      <CardHeader className="space-y-1">
        ...
        <CardDescription>
          {step === 1 ? '데이터베이스 연결 정보를 설정합니다.' : '초기 관리자 계정을 생성합니다.'}
        </CardDescription>
      </CardHeader>
